# AUTOGENERATED! DO NOT EDIT! File to edit: ../00_processing.ipynb.

# %% auto 0
__all__ = ['SALAFrame', 'remove_first_day']

# %% ../00_processing.ipynb 3
import numpy as np
import pandas as pd
